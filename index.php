...
$json_data_logdir = "/var/www/html/weewx/ecowitt";
$txt_data_logdir = "/var/www/html/weewx/ecowitt";
...
$txt_dir_weewx = "/var/www/html/weewx/ecowitt";
...
$json_weewx_logfile = $txt_dir_weewx . "/weather_4C87153A3CDBE6C79DF6E00729153990.json";
$file_json = fopen($json_weewx_logfile, 'r');
$result_json = fread($file_json, filesize($json_weewx_logfile));
#echo $result_json;
#echo gettype($result_json);
fclose($file_json);

$array_weather_data = json_decode($result_json, true);
#echo gettype($array_weather_data);
#print_r($array_weather_data);
$tempIndoor = $array_weather_data['tempinc'];
echo $tempIndoor;
echo gettype($tempIndoor);
$tempOutdoor = $array_weather_data['tempc'];
$dewPoint = $array_weather_data['dewptc'];
$humidIndoor = $array_weather_data['humidityin'];
$humidOutdoor = $array_weather_data['humidity'];
$windSpeed = $array_weather_data['windspeedkmh'];
$windDir = $array_weather_data['winddir'];
$dailyRain = $array_weather_data['dailyrainmm'];
$weeklyRain = $array_weather_data['weeklyrainmm'];
$monthlyRain = $array_weather_data['monthlyrainmm'];
$totalRainInch = $array_weather_data['totalrainin'];
$pressure = $array_weather_data['baromrelhpa'];
$solarRadiation = $array_weather_data['solarradiation'];
$UV = $array_weather_data['uv']; 


###################################################################################################################
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.netpie.io/v2/device/shadow/data');
$request->setMethod(HTTP_Request2::METHOD_POST);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
$request->setHeader(array(
  'Authorization' => 'Device a270709c-3876-46dd-b40f-68fdd2caf4b9:d6KWkT1zUthm5j1np6sxLrsytJwpvyXy',
  'Content-Type' => 'application/json'
));
$request->setBody("{'data':{'tempIndoor':$tempIndoor,'tempOutdoor':$tempOutdoor,'humidIndoor':$humidIndoor,'humidOutdoor':$humidOutdoor,'dewpoint':$dewPoint,'windSpeed':$windSpeed,'windDir':$windDir,'dailyRain':$dailyRain,'weeklyRain':$weeklyRain,'monthlyRain':$monthlyRain,'totalRainInch':$totalRainInch,'solarRadiation':$solarRadiation,'UV':$UV}}");
//$request->setBody("{'data':{'tempIndoor':$tempIndoor}}");
//$request->setBody('{"data": {"uo":45, "jk":"jhkl"}}');
