...
#Settings: Forward to NETPIE PLATFORM
########## Authorize with Basic Auth ##############
$clientID = "a270709c-3876-46dd-b40f-68fdd2caf4b9"; 
$token = "d6KWkT1zUthm5j1np6sxLrsytJwpvyXy";
###################################################
header();
include "httpful.phar";
$endpoint = "https://api.netpie.io/v2/device/message/data";
$forward_json_data = \Httpful\Request::post($endpoint);
	->header('Host: api.netpie.io/v2/device');
	->header('Authorization: Device 777d5c96-4c83-4aa6-a273-5ee7c5f453b1:abcduKh8r2tP1zVc1W1nG8YWZeu21234');
...
$file_txt = fopen($txt_weewx_logfile);
