<?php
	...
	if ( $forward_data == 1 ) 
	{
		...
		$weather_data_url = $weather_data_forward['forward_url'] . "?" . "U=" . @$weather_data_forward['U'] . "&PASS=" . @$weather_data_forward['PASS'] . "&T=" . @$weather_data_forward['T'] . "&H=" . @$weather_data_forward['H'] ."&P=" . @$weather_data_forward['P'] . "&W=" . @$weather_data_forward['W'] . "&G=" . @$weather_data_forward['G'] . "&B=" . @$weather_data_forward['B'] . "&R=" . @$weather_data_forward['R'] . "&RR=" . @$weather_data_forward['RR'] . "&S=" . @$weather_data_forward['S'] . "&UV=" . @$weather_data_forward['UV'] . "&TIN=" . @$weather_data_forward['TIN'] . "&HIN=" . @$weather_data_forward['HIN'] . "&T1=" . @$weather_data_forward['T1'] . "&H1=" . @$weather_data_forward['H1'] . "&T2=" . @$weather_data_forward['T2'] . "&H2=" . @$weather_data_forward['H2'] .  "&SM1=" . @$weather_data_forward['SM1'] . "&SM2=" . @$weather_data_forward['SM2'] . "&L=" . @$weather_data_forward['L'] . "&LD=" . @$weather_data_forward['LD'] . "&LT=" . @$weather_data_forward['LT'] . "&PP1=" . @$weather_data_forward['PP1'] ;
		
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, $weather_data_url );
	curl_setopt($ch, CURLOPT_HEADER, false);
	$out = curl_exec($ch);
	curl_close($ch);
	#echo $out;

	#$weather_data_forward_json = json_encode($weather_data_forward);
	#$api_data_logfile = $json_data_logdir . "/" . $device . ".txt";
	#$file2 = fopen($api_data_logfile, 'w');
	#fwrite($file2, $weather_data_url);
	#fclose($file2);
	
	#$curl_data_logfile = $json_data_logdir . "/" . $device . "_curl.txt";
	#$file3 = fopen($curl_data_logfile, 'w');
	#fwrite($file3, $out);
	#fclose($file3);
